...
\begin{figure}[H]
	\begin{center}
	\includegraphics[width=\textwidth]{1row_diagram.png}\\ 
...
Applying this solution to one chain of our circuit by calculating $R_{20}$, with $R_c = 10^4$ and $R_M = 10^6$, results in an equivalent resistance of about $102K\Omega$. To calculate the current one chain draws, we use Ohm's Law:
...
\begin{figure}[H]
	\begin{center}
	\includegraphics[width=\textwidth, ]{resistor_layout_naive.png}\\ 
...
\begin{figure}[H]
	\begin{center}
	\includegraphics[width=\textwidth, ]{resistor_layout_square.png}\\ 
...
\begin{figure}[H]
	\begin{center}
	\includegraphics[width=0.8\textwidth, ]{resistor_layout_slanted.png}\\ 
